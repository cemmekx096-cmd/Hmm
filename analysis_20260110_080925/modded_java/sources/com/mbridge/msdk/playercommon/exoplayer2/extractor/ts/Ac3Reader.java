...
public final class Ac3Reader implements ElementaryStreamReader {
    ...
    private void parseHeader() {
        ...
        if (format == null || ac3SyncframeInfo.channelCount != format.channelCount || ac3SyncframeInfo.sampleRate != format.sampleRate || ac3SyncframeInfo.mimeType != format.sampleMimeType) {
            Format formatCreateAudioSampleFormat = Format.createAudioSampleFormat(this.trackFormatId, ac3SyncframeInfo.mimeType, (String) null, -1, -1, ac3SyncframeInfo.channelCount, ac3SyncframeInfo.sampleRate, (List) null, (DrmInitData) null, 0, this.language);
