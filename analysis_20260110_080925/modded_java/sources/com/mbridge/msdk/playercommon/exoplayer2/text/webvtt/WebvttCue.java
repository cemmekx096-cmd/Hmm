...
public final class WebvttCue extends Cue {
    ...
    public static class Builder {
        ...
        private Builder derivePositionAnchorFromAlignment() {
            ...
            if (alignment == null) {
                this.positionAnchor = ExoMediaDrm.KeyRequest.REQUEST_TYPE_UNKNOWN;
            } else {
        ...
        public void reset() {
            ...
            this.lineType = ExoMediaDrm.KeyRequest.REQUEST_TYPE_UNKNOWN;
            this.lineAnchor = ExoMediaDrm.KeyRequest.REQUEST_TYPE_UNKNOWN;
    ...
    public boolean isNormalCue() {
        return ((Cue) this).line == Float.MIN_VALUE && ((Cue) this).position == Float.MIN_VALUE;
    }

    public WebvttCue(long j, long j2, CharSequence charSequence) {
        this(j, j2, charSequence, null, Float.MIN_VALUE, ExoMediaDrm.KeyRequest.REQUEST_TYPE_UNKNOWN, ExoMediaDrm.KeyRequest.REQUEST_TYPE_UNKNOWN, Float.MIN_VALUE, ExoMediaDrm.KeyRequest.REQUEST_TYPE_UNKNOWN, Float.MIN_VALUE);
    }
