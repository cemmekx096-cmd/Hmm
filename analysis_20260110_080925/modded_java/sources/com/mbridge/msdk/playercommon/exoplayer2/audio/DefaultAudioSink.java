...
public final class DefaultAudioSink implements AudioSink {
    ...
    private AudioTrack createAudioTrackV21() {
        AudioAttributes audioAttributesBuild = this.tunneling ? new AudioAttributes.Builder().setContentType(3).setFlags(16).setUsage(1).build() : this.audioAttributes.getAudioAttributesV21();
    ...
    */
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.audio.AudioSink
    public boolean handleBuffer(ByteBuffer byteBuffer, long j) throws AudioSink.InitializationException, IllegalStateException, AudioSink.WriteException {
    ...
    public DefaultAudioSink(AudioCapabilities audioCapabilities, AudioProcessorChain audioProcessorChain, boolean z) {
        ...
        AudioProcessor channelMappingAudioProcessor = new ChannelMappingAudioProcessor();
        this.channelMappingAudioProcessor = channelMappingAudioProcessor;
        AudioProcessor trimmingAudioProcessor = new TrimmingAudioProcessor();
