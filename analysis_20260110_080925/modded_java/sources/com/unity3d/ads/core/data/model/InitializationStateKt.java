...
public final class InitializationStateKt {
    ...
    public static final SdkProperties.InitializationState toLegacy(InitializationState initializationState) throws NoWhenBranchMatchedException {
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: kotlin.NoWhenBranchMatchedException */
    public static final InitializationState toBold(SdkProperties.InitializationState initializationState) throws NoWhenBranchMatchedException {
        Intrinsics.checkNotNullParameter(initializationState, "<this>");
