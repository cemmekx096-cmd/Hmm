...
public class AdOperationMetric {
    ...
    public static Metric newAdLoadStart(boolean z, boolean z2) {
        return new Metric(AD_LOAD_START, (Object) null, getTags(null, false, z, Boolean.valueOf(z2)));
    }

    public static Metric newAdShowStart() {
        return new Metric(AD_SHOW_START, (Object) null, getTags(null, false, false, null));
    }
