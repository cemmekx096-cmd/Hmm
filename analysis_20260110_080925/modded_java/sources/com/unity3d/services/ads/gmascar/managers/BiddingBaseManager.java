...
public abstract class BiddingBaseManager implements IBiddingManager {
    ...
    protected BiddingBaseManager(IUnityAdsTokenListener iUnityAdsTokenListener) {
        this(null, iUnityAdsTokenListener, new ScarRequestHandler());
    }

    protected BiddingBaseManager(IScarAdFormatProvider iScarAdFormatProvider, IUnityAdsTokenListener iUnityAdsTokenListener) {
    ...
    public String getFormattedToken(String str) {
        ...
        return (tokenIdentifier == null || tokenIdentifier.isEmpty()) ? str : String.format("%s:%s", tokenIdentifier, str);
    }
    ...
    /* synthetic */ void m1031x87509455(String str) {
    ...
    public void fetchSignals() {
        ...
        new Thread((Runnable) new BiddingBaseManager$.ExternalSyntheticLambda0(this)).start();
    }
    ...
    /* synthetic */ void m1030xbd500567() {
        GMA.getInstance().getSCARBiddingSignals(this.scarAdFormatProvider.buildAdFormatList(), new IBiddingSignalsListener() { // from class: com.unity3d.services.ads.gmascar.managers.BiddingBaseManager.1
            public void onSignalsReady(BiddingSignals biddingSignals) {
                ...
                BiddingBaseManager.this.sendFetchResult(BuildConfig.FLAVOR);
            }
    ...
    public void uploadSignals() {
        ...
        if (biddingSignals == null || biddingSignals.isEmpty()) {
            ...
            new Thread((Runnable) new BiddingBaseManager$.ExternalSyntheticLambda2(this, biddingSignals)).start();
        }
    }
    ...
    /* synthetic */ void m1032xb93d3227(BiddingSignals biddingSignals) {
        try {
