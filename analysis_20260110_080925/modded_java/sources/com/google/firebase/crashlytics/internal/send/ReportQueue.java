...
final class ReportQueue {
    ...
    public void flushScheduledReportsIfAble() {
        ...
        new Thread((Runnable) new ReportQueue$.ExternalSyntheticLambda1(this, countDownLatch)).start();
    ...
    /* synthetic */ void m220x23ee29ee(CountDownLatch countDownLatch) {
        try {
    ...
    /* synthetic */ void m221xc033738(TaskCompletionSource taskCompletionSource, boolean z, CrashlyticsReportWithSessionId crashlyticsReportWithSessionId, Exception exc) {
        if (exc != null) {
