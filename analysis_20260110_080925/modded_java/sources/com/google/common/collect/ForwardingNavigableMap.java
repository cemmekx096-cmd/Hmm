...
public abstract class ForwardingNavigableMap<K, V> extends ForwardingSortedMap<K, V> implements NavigableMap<K, V> {
    ...
    public abstract NavigableMap<K, V> m150delegate();
    ...
    public Map.Entry<K, V> lowerEntry(@ParametricNullness K k) {
        return m150delegate().lowerEntry(k);
    }
    ...
    public K lowerKey(@ParametricNullness K k) {
        return m150delegate().lowerKey(k);
    }
    ...
    public Map.Entry<K, V> floorEntry(@ParametricNullness K k) {
        return m150delegate().floorEntry(k);
    }
    ...
    public K floorKey(@ParametricNullness K k) {
        return m150delegate().floorKey(k);
    }
    ...
    public Map.Entry<K, V> ceilingEntry(@ParametricNullness K k) {
        return m150delegate().ceilingEntry(k);
    }
    ...
    public K ceilingKey(@ParametricNullness K k) {
        return m150delegate().ceilingKey(k);
    }
    ...
    public Map.Entry<K, V> higherEntry(@ParametricNullness K k) {
        return m150delegate().higherEntry(k);
    }
    ...
    public K higherKey(@ParametricNullness K k) {
        return m150delegate().higherKey(k);
    }
    ...
    public Map.Entry<K, V> firstEntry() {
        return m150delegate().firstEntry();
    }
    ...
    public Map.Entry<K, V> pollFirstEntry() {
        return m150delegate().pollFirstEntry();
    }
    ...
    public Map.Entry<K, V> pollLastEntry() {
        return m150delegate().pollLastEntry();
    }
    ...
    public NavigableMap<K, V> descendingMap() {
        return m150delegate().descendingMap();
    }
    ...
    public NavigableSet<K> navigableKeySet() {
        return m150delegate().navigableKeySet();
    }
    ...
    public NavigableSet<K> descendingKeySet() {
        return m150delegate().descendingKeySet();
    }
    ...
    public NavigableMap<K, V> subMap(@ParametricNullness K k, boolean z, @ParametricNullness K k2, boolean z2) {
        return m150delegate().subMap(k, z, k2, z2);
    }

    @Override // java.util.NavigableMap
    public NavigableMap<K, V> headMap(@ParametricNullness K k, boolean z) {
        return m150delegate().headMap(k, z);
    }

    @Override // java.util.NavigableMap
    public NavigableMap<K, V> tailMap(@ParametricNullness K k, boolean z) {
        return m150delegate().tailMap(k, z);
    }
