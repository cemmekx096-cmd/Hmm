...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    private List<String> getFieldNames(Field field) {
        ...
        String[] strArrAlternate = annotation.alternate();
    ...
    private BoundField createBoundField(final Gson gson, final Field field, String str, final TypeToken<?> typeToken, boolean z, boolean z2) {
        ...
        TypeAdapter typeAdapter = annotation != null ? this.jsonAdapterFactory.getTypeAdapter(this.constructorConstructor, gson, typeToken, annotation) : null;
    ...
    public static final class Adapter<T> extends TypeAdapter<T> {
        ...
        public T read(JsonReader jsonReader) throws JsonSyntaxException, IOException {
