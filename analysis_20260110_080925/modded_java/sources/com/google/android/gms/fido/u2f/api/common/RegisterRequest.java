...
public class RegisterRequest extends AbstractSafeParcelable {
    ...
    public static RegisterRequest parseFromJson(JSONObject jSONObject) throws JSONException {
        try {
            try {
                try {
                    return new RegisterRequest(ProtocolVersion.fromString(jSONObject.has(JsonParser.EXCLUDE_VERSION) ? jSONObject.getString(JsonParser.EXCLUDE_VERSION) : null), Base64.decode(jSONObject.getString("challenge"), 8), jSONObject.has("appId") ? jSONObject.getString("appId") : null);
    ...
    public JSONObject toJson() throws JSONException {
        ...
        try {
            jSONObject.put(JsonParser.EXCLUDE_VERSION, this.zzb.toString());
