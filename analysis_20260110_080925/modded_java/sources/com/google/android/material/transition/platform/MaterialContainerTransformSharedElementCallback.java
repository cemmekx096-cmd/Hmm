...
public class MaterialContainerTransformSharedElementCallback extends SharedElementCallback {
    ...
    private void setUpEnterTransform(final Window window) {
        MaterialContainerTransform sharedElementEnterTransition = window.getSharedElementEnterTransition();
        if (sharedElementEnterTransition instanceof MaterialContainerTransform) {
            MaterialContainerTransform materialContainerTransform = sharedElementEnterTransition;
    ...
    private void setUpReturnTransform(final Activity activity, final Window window) {
        MaterialContainerTransform sharedElementReturnTransition = window.getSharedElementReturnTransition();
        if (sharedElementReturnTransition instanceof MaterialContainerTransform) {
            MaterialContainerTransform materialContainerTransform = sharedElementReturnTransition;
