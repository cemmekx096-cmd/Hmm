...
public class TreeWalker implements a.a {
    ...
    private void a(View view, com.iab.omid.library.ironsrc.processor.a aVar, JSONObject jSONObject, com.iab.omid.library.ironsrc.walking.c cVar, boolean z) {
        aVar.a(view, jSONObject, this, cVar == com.iab.omid.library.ironsrc.walking.c.a, z);
    }
    ...
    private boolean a(View view, JSONObject jSONObject) {
        ...
        com.iab.omid.library.ironsrc.utils.c.a(jSONObject, aVarB);
        return true;
    }
    ...
    private void e() {
        ...
        this.d.clear();
        this.c = false;
        Iterator it = com.iab.omid.library.ironsrc.internal.c.c().a().iterator();
        while (true) {
            if (!it.hasNext()) {
                break;
            } else if (((com.iab.omid.library.ironsrc.adsession.a) it.next()).e()) {
                this.c = true;
                break;
            }
        }
    ...
    public void a(View view, com.iab.omid.library.ironsrc.processor.a aVar, JSONObject jSONObject, boolean z) {
        ...
        if (h.f(view) && (cVarD = this.f.d(view)) != com.iab.omid.library.ironsrc.walking.c.c) {
            JSONObject jSONObjectA = aVar.a(view);
            com.iab.omid.library.ironsrc.utils.c.a(jSONObject, jSONObjectA);
            if (!b(view, jSONObjectA)) {
                boolean z2 = z || a(view, jSONObjectA);
                if (this.c && cVarD == com.iab.omid.library.ironsrc.walking.c.b && !z2) {
    ...
    void f() {
        ...
        if (this.f.c().size() > 0) {
            ...
            a(null, aVarA, jSONObjectA2, com.iab.omid.library.ironsrc.walking.c.a, false);
            com.iab.omid.library.ironsrc.utils.c.b(jSONObjectA2);
            this.g.b(jSONObjectA2, this.f.c(), jB);
            if (this.c) {
                Iterator it2 = com.iab.omid.library.ironsrc.internal.c.c().a().iterator();
                while (it2.hasNext()) {
                    ((com.iab.omid.library.ironsrc.adsession.a) it2.next()).a(this.d);
                }
            }
        } else {
            this.g.b();
