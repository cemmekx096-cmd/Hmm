...
final class zzbf extends com.google.android.gms.internal.play_billing.zzaf {
    ...
    public final void zza(Bundle bundle) throws RemoteException {
        ...
        if (iZzb != 0) {
            zze.zzl("BillingClient", "Unable to launch intent for external offer dialog" + iZzb);
        ...
        if (pendingIntent == null) {
            zze.zzl("BillingClient", "The PendingIntent for the external offer dialog is null");
        ...
        try {
            ...
            zze.zzm("BillingClient", "Runtime error while launching intent for the external offer dialog.", e);
