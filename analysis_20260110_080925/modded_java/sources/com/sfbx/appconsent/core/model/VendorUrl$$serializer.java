...
public final class VendorUrl$$serializer implements GeneratedSerializer<VendorUrl> {
    ...
    static {
        ...
        SerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.sfbx.appconsent.core.model.VendorUrl", vendorUrl$$serializer, 2);
        pluginGeneratedSerialDescriptor.addElement("policyUrl", true);
        pluginGeneratedSerialDescriptor.addElement("legIntClaimUrl", true);
    ...
    public VendorUrl m998deserialize(Decoder decoder) throws UnknownFieldException {
        ...
        return new VendorUrl(i, strDecodeStringElement, strDecodeStringElement2, (SerializationConstructorMarker) null);
    }
