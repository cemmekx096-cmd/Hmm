...
import androidx.core.view.ViewCompat$Api28Impl$;
...
public class ViewCompat {
    ...
    static void notifyViewAccessibilityStateChangedIfNeeded(View view, int i) {
        ...
        if (accessibilityManager.isEnabled()) {
            ...
            if (getAccessibilityLiveRegion(view) != 0 || z) {
                ...
                accessibilityEventObtain.setEventType(z ? 32 : RendererCapabilities.AUDIO_OFFLOAD_SPEED_CHANGE_SUPPORTED);
    ...
    static class Api28Impl {
        ...
        static void addOnUnhandledKeyEventListener(View view, OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
            ...
            View.OnUnhandledKeyEventListener externalSyntheticLambda0 = new ViewCompat$Api28Impl$.ExternalSyntheticLambda0(onUnhandledKeyEventListenerCompat);
            simpleArrayMap.put(onUnhandledKeyEventListenerCompat, externalSyntheticLambda0);
            view.addOnUnhandledKeyEventListener(externalSyntheticLambda0);
        }
