...
public abstract class PreferenceDialogFragment extends DialogFragment implements DialogInterface.OnClickListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        DialogPreference.TargetFragment targetFragment2 = targetFragment;
        String string = getArguments().getString(ARG_KEY);
        if (bundle == null) {
            DialogPreference dialogPreferenceFindPreference = targetFragment2.findPreference(string);
            this.mPreference = dialogPreferenceFindPreference;
            this.mDialogTitle = dialogPreferenceFindPreference.getDialogTitle();
    ...
    public DialogPreference getPreference() {
        if (this.mPreference == null) {
            this.mPreference = getTargetFragment().findPreference(getArguments().getString(ARG_KEY));
        }
