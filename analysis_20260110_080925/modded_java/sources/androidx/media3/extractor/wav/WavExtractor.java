...
public final class WavExtractor implements Extractor {
    ...
    public int read(ExtractorInput extractorInput, PositionHolder positionHolder) throws ParserException, IOException {
        assertInitialized();
        int i = this.state;
        if (i == 0) {
    ...
    private void readFileType(ExtractorInput extractorInput) throws ParserException, IOException {
    ...
    private void readFormat(ExtractorInput extractorInput) throws ParserException, IOException {
    ...
    private void skipToSampleData(ExtractorInput extractorInput) throws ParserException, IOException {
    ...
    private static final class PassthroughOutputWriter implements OutputWriter {
        ...
        public PassthroughOutputWriter(ExtractorOutput extractorOutput, TrackOutput trackOutput, WavFormat wavFormat, String str, int i) throws ParserException {
            ...
            if (wavFormat.blockSize != i2) {
                throw ParserException.createForMalformedContainer("Expected block size: " + i2 + "; got: " + wavFormat.blockSize, (Throwable) null);
            }
        ...
        public boolean sampleData(ExtractorInput extractorInput, long j) throws IOException {
            ...
            if (i4 > 0) {
                ...
                this.trackOutput.sampleMetadata(jScaleLargeTimestamp, 1, i5, i6, (TrackOutput.CryptoData) null);
    ...
    private static final class ImaAdPcmOutputWriter implements OutputWriter {
        ...
        private static final int[] STEP_TABLE = {7, 8, 9, 10, 11, 12, 13, 14, 16, 17, 19, 21, 23, 25, 28, 31, 34, 37, 41, 45, 50, 55, 60, 66, 73, 80, 88, 97, 107, R.styleable.AppCompatTheme_windowActionBarOverlay, 130, 143, 157, 173, 190, 209, 230, 253, 279, 307, 337, 371, 408, 449, 494, 544, 598, 658, 724, 796, 876, 963, 1060, 1166, 1282, 1411, 1552, 1707, 1878, 2066, 2272, 2499, 2749, 3024, 3327, 3660, 4026, 4428, 4871, 5358, 5894, 6484, 7132, 7845, 8630, 9493, 10442, 11487, 12635, 13899, 15289, 16818, 18500, 20350, 22385, 24623, 27086, 29794, 32767};
        ...
        public ImaAdPcmOutputWriter(ExtractorOutput extractorOutput, TrackOutput trackOutput, WavFormat wavFormat) throws ParserException {
            ...
            if (littleEndianUnsignedShort != i2) {
                throw ParserException.createForMalformedContainer("Expected frames per block: " + i2 + "; got: " + littleEndianUnsignedShort, (Throwable) null);
            }
        ...
        */
        ...
        private void writeSampleMetadata(int i) {
            ...
            this.trackOutput.sampleMetadata(jScaleLargeTimestamp, 1, iNumOutputFramesToBytes, this.pendingOutputBytes - iNumOutputFramesToBytes, (TrackOutput.CryptoData) null);
