    ...
    public static void setFormatMetadata(int i, Metadata metadata, Format.Builder builder, Metadata... metadataArr) {
        ...
        if (metadata != null) {
            for (int i2 = 0; i2 < metadata.length(); i2++) {
                MdtaMetadataEntry mdtaMetadataEntry = metadata.get(i2);
                if (mdtaMetadataEntry instanceof MdtaMetadataEntry) {
                    MdtaMetadataEntry mdtaMetadataEntry2 = mdtaMetadataEntry;
                    if (!mdtaMetadataEntry2.key.equals("com.android.capture.fps")) {
                        metadata2 = metadata2.copyWithAppendedEntries(mdtaMetadataEntry2);
                    } else if (i == 2) {
                        metadata2 = metadata2.copyWithAppendedEntries(mdtaMetadataEntry2);
                    }
                }
