...
public final class DvbParser implements SubtitleParser {
    ...
    private static ClutDefinition parseClutDefinition(ParsableBitArray parsableBitArray, int i) {
        ...
        while (i5 > 0) {
            ...
            int i6 = i5 - 2;
            int[] iArr = (bits7 & RendererCapabilities.DECODER_SUPPORT_PRIMARY) != 0 ? iArrGenerateDefault2BitClutEntries : (bits7 & 64) != 0 ? iArrGenerateDefault4BitClutEntries : iArrGenerateDefault8BitClutEntries;
            if ((bits7 & 1) != 0) {
