...
public abstract class DecoderAudioRenderer<T extends Decoder<DecoderInputBuffer, ? extends SimpleDecoderOutputBuffer, ? extends DecoderException>> extends BaseRenderer implements MediaClock {
    ...
    public void render(long j, long j2) throws ExoPlaybackException {
        ...
        if (this.decoder != null) {
            try {
                ...
                throw createRendererException(e5, this.inputFormat, 4003);
    ...
    private boolean feedInputBuffer() throws ExoPlaybackException, DecoderException {
        ...
        if (this.inputBuffer.timeUs < getLastResetPositionUs()) {
            this.inputBuffer.addFlag(ExoMediaDrm.KeyRequest.REQUEST_TYPE_UNKNOWN);
        }
    ...
    private void onInputFormatChanged(FormatHolder formatHolder) throws ExoPlaybackException {
        ...
        if (this.sourceDrmSession != this.decoderDrmSession) {
            decoderReuseEvaluationCanReuseDecoder = new DecoderReuseEvaluation(this.decoder.getName(), format2, format, 0, RendererCapabilities.DECODER_SUPPORT_PRIMARY);
        } else {
