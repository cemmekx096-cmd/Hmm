...
public abstract class SegmentDownloader<M extends FilterableManifest<M>> implements Downloader {
    ...
    public SegmentDownloader(MediaItem mediaItem, ParsingLoadable.Parser<M> parser, CacheDataSource.Factory factory, Executor executor) {
        this(mediaItem, parser, factory, executor, DEFAULT_MAX_MERGED_SEGMENT_START_TIME_DIFF_MS);
    }
    ...
    /* JADX WARN: Type inference failed for: r8v4, types: [androidx.media3.common.util.RunnableFutureTask, androidx.media3.exoplayer.offline.SegmentDownloader$SegmentDownloadRunnable, java.lang.Runnable] */
    public final void download(Downloader.ProgressListener progressListener) throws InterruptedException, IOException {
        ...
        try {
            ...
            while (!this.isCanceled && !arrayDeque.isEmpty()) {
                ...
                ?? segmentDownloadRunnable2 = new SegmentDownloadRunnable((Segment) arrayDeque.removeFirst(), cacheDataSourceCreateDataSourceForDownloading, progressNotifier, bArr);
    ...
    protected final M getManifest(final DataSource dataSource, final DataSpec dataSpec, boolean z) throws InterruptedException, IOException {
        return (M) execute(new RunnableFutureTask<M, IOException>() { // from class: androidx.media3.exoplayer.offline.SegmentDownloader.1
            ...
            public M m36doWork() throws IOException {
