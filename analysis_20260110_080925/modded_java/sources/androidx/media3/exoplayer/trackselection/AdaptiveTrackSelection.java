...
public class AdaptiveTrackSelection extends BaseTrackSelection {
    ...
    public static class Factory implements ExoTrackSelection.Factory {
        ...
        public final ExoTrackSelection[] createTrackSelections(ExoTrackSelection.Definition[] definitionArr, BandwidthMeter bandwidthMeter, MediaSource.MediaPeriodId mediaPeriodId, Timeline timeline) {
            FixedTrackSelection fixedTrackSelectionCreateAdaptiveTrackSelection;
            ...
            for (int i = 0; i < definitionArr.length; i++) {
                ...
                if (definition != null && definition.tracks.length != 0) {
                    if (definition.tracks.length == 1) {
                        fixedTrackSelectionCreateAdaptiveTrackSelection = new FixedTrackSelection(definition.group, definition.tracks[0], definition.type);
                    } else {
                        fixedTrackSelectionCreateAdaptiveTrackSelection = createAdaptiveTrackSelection(definition.group, definition.tracks, definition.type, bandwidthMeter, (ImmutableList) adaptationCheckpoints.get(i));
                    }
                    exoTrackSelectionArr[i] = fixedTrackSelectionCreateAdaptiveTrackSelection;
                }
            }
