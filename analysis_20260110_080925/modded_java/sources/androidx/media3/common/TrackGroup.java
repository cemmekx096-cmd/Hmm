...
public final class TrackGroup implements Bundleable {
    ...
    private static int normalizeRoleFlags(int i) {
        return i | JsonLexerKt.BATCH_SIZE;
    }

    public TrackGroup(Format... formatArr) {
        this(com.crashlytics.android.BuildConfig.FLAVOR, formatArr);
    }
    ...
    static /* synthetic */ TrackGroup lambda$static$0(Bundle bundle) {
        ...
        return new TrackGroup(bundle.getString(FIELD_ID, com.crashlytics.android.BuildConfig.FLAVOR), (Format[]) immutableListFromBundleList.toArray(new Format[0]));
    }
    ...
    private static String normalizeLanguage(String str) {
        return (str == null || str.equals("und")) ? com.crashlytics.android.BuildConfig.FLAVOR : str;
    }

    private static void logErrorMessage(String str, String str2, String str3, int i) {
        Log.e(TAG, com.crashlytics.android.BuildConfig.FLAVOR, new IllegalStateException("Different " + str + " combined in one TrackGroup: '" + str2 + "' (track 0) and '" + str3 + "' (track " + i + ")"));
    }
}
