        ...
        while (i < length) {
            ...
            if (cCharAt2 < 128) {
                ...
                try {
                    ...
                    byteBuffer.put(i2, (byte) ((cCharAt2 & '?') | RendererCapabilities.DECODER_SUPPORT_PRIMARY));
                    iPosition = i2;
                ...
                iPosition = i3 + 1;
                byteBuffer.put(i3, (byte) (((cCharAt2 >>> 6) & 63) | RendererCapabilities.DECODER_SUPPORT_PRIMARY));
                byteBuffer.put(iPosition, (byte) ((cCharAt2 & '?') | RendererCapabilities.DECODER_SUPPORT_PRIMARY));
            } else {
                int i4 = i + 1;
                if (i4 != length) {
                    try {
                        ...
                        if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                            ...
                            try {
                                ...
                                int i6 = i5 + 1;
                                byteBuffer.put(i5, (byte) (((codePoint >>> 12) & 63) | RendererCapabilities.DECODER_SUPPORT_PRIMARY));
                                int i7 = i6 + 1;
                                byteBuffer.put(i6, (byte) (((codePoint >>> 6) & 63) | RendererCapabilities.DECODER_SUPPORT_PRIMARY));
                                byteBuffer.put(i7, (byte) ((codePoint & 63) | RendererCapabilities.DECODER_SUPPORT_PRIMARY));
                                iPosition = i7;
                                i = i4;
        ...
        while (i7 < length) {
            ...
            if (cCharAt2 >= 128 || i8 >= i6) {
                if (cCharAt2 < 2048 && i8 <= i6 - 2) {
                    ...
                    i8 = i9 + 1;
                    bArr[i9] = (byte) ((cCharAt2 & '?') | RendererCapabilities.DECODER_SUPPORT_PRIMARY);
                } else {
                        ...
                        if (i8 <= i6 - 4) {
                            ...
                            if (i10 != charSequence.length()) {
                                ...
                                if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                    ...
                                    int i12 = i11 + 1;
                                    bArr[i11] = (byte) (((codePoint >>> 12) & 63) | RendererCapabilities.DECODER_SUPPORT_PRIMARY);
                                    int i13 = i12 + 1;
                                    bArr[i12] = (byte) (((codePoint >>> 6) & 63) | RendererCapabilities.DECODER_SUPPORT_PRIMARY);
                                    i8 = i13 + 1;
                                    bArr[i13] = (byte) ((codePoint & 63) | RendererCapabilities.DECODER_SUPPORT_PRIMARY);
                                    i7 = i10;
                                } else {
                                    i7 = i10;
                                }
                    ...
                    int i15 = i14 + 1;
                    bArr[i14] = (byte) (((cCharAt2 >>> 6) & 63) | RendererCapabilities.DECODER_SUPPORT_PRIMARY);
                    i3 = i15 + 1;
                    bArr[i15] = (byte) ((cCharAt2 & '?') | RendererCapabilities.DECODER_SUPPORT_PRIMARY);
                }
                i7++;
            } else {
                i3 = i8 + 1;
