...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
    ...
    private static class AnimatedVectorDrawableDelegateState extends Drawable.ConstantState {
        ...
        /* JADX WARN: Type inference failed for: r0v0, types: [android.graphics.drawable.Drawable, androidx.vectordrawable.graphics.drawable.AnimatedVectorDrawableCompat] */
        @Override // android.graphics.drawable.Drawable.ConstantState
        public Drawable newDrawable() {
            ?? animatedVectorDrawableCompat = new AnimatedVectorDrawableCompat();
            ((AnimatedVectorDrawableCompat) animatedVectorDrawableCompat).mDelegateDrawable = this.mDelegateState.newDrawable();
            ((AnimatedVectorDrawableCompat) animatedVectorDrawableCompat).mDelegateDrawable.setCallback(animatedVectorDrawableCompat.mCallback);
            return animatedVectorDrawableCompat;
        }
        ...
        public Drawable newDrawable(Resources resources) {
            ?? animatedVectorDrawableCompat = new AnimatedVectorDrawableCompat();
            ((AnimatedVectorDrawableCompat) animatedVectorDrawableCompat).mDelegateDrawable = this.mDelegateState.newDrawable(resources);
            ((AnimatedVectorDrawableCompat) animatedVectorDrawableCompat).mDelegateDrawable.setCallback(animatedVectorDrawableCompat.mCallback);
            return animatedVectorDrawableCompat;
        }
        ...
        public Drawable newDrawable(Resources resources, Resources.Theme theme) {
            ?? animatedVectorDrawableCompat = new AnimatedVectorDrawableCompat();
            ((AnimatedVectorDrawableCompat) animatedVectorDrawableCompat).mDelegateDrawable = this.mDelegateState.newDrawable(resources, theme);
            ((AnimatedVectorDrawableCompat) animatedVectorDrawableCompat).mDelegateDrawable.setCallback(animatedVectorDrawableCompat.mCallback);
            return animatedVectorDrawableCompat;
        }
        ...
        public AnimatedVectorDrawableCompatState(Context context, AnimatedVectorDrawableCompatState animatedVectorDrawableCompatState, Drawable.Callback callback, Resources resources) {
            if (animatedVectorDrawableCompatState != null) {
                ...
                if (vectorDrawableCompat != null) {
                    ...
                    VectorDrawableCompat vectorDrawableCompatMutate = this.mVectorDrawable.mutate();
                    this.mVectorDrawable = vectorDrawableCompatMutate;
                    vectorDrawableCompatMutate.setCallback(callback);
