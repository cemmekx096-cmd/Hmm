...
public final class EnumSerializer<T extends Enum<T>> implements KSerializer<T> {
    ...
    public EnumSerializer(final String str, T[] tArr) {
        ...
        this.descriptor = LazyKt.lazy(new Function0<SerialDescriptor>(this) { // from class: kotlinx.serialization.internal.EnumSerializer$descriptor$2
            ...
            public final SerialDescriptor invoke() {
                ...
                return serialDescriptor == null ? this.this$0.createUnmarkedDescriptor(str) : serialDescriptor;
            }
        });
    }
    ...
    public final SerialDescriptor createUnmarkedDescriptor(String serialName) {
        PluginGeneratedSerialDescriptor enumDescriptor = new EnumDescriptor(serialName, this.values.length);
        for (T t : this.values) {
            PluginGeneratedSerialDescriptor.addElement$default(enumDescriptor, t.name(), false, 2, (Object) null);
        }
        return (SerialDescriptor) enumDescriptor;
    }
    ...
    public T m1354deserialize(Decoder decoder) {
