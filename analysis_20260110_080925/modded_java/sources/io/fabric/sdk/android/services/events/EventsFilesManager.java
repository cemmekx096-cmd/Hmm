...
public abstract class EventsFilesManager<T> {
    ...
    public boolean rollFileOver() throws IOException {
        String strGenerateUniqueRollOverFileName;
        boolean z = true;
        if (this.eventStorage.isWorkingFileEmpty()) {
            ...
            CommonUtils.logControlled(this.context, 4, "Fabric", String.format(Locale.US, "generated new file %s", strGenerateUniqueRollOverFileName));
    ...
    private void rollFileOverIfNeeded(int i) throws IOException {
        ...
        CommonUtils.logControlled(this.context, 4, "Fabric", String.format(Locale.US, "session analytics events file is %d bytes, new event is %d bytes, this is over flush limit of %d, rolling it over", Integer.valueOf(this.eventStorage.getWorkingFileUsedSizeInBytes()), Integer.valueOf(i), Integer.valueOf(getMaxByteSizePerFile())));
        rollFileOver();
    }
