...
@Metadata(d1 = {"\u0000\u001a\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\u001a\u0018\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u0002\u001a\u0016\u0010\u0006\u001a\u00020\u0001*\u00020\u00072\b\b\u0002\u0010\u0002\u001a\u00020\u0003H\u0000¨\u0006\b"}, d2 = {"printlnWithOffset", BuildConfig.FLAVOR, "offset", BuildConfig.FLAVOR, "node", BuildConfig.FLAVOR, "printDebug", "Lio/ktor/http/parsing/Grammar;", "ktor-http"}, k = 2, mv = {1, 8, 0}, xi = 48)
/* loaded from: /data/data/com.termux/files/home/mod/mod/classes4.dex */
public final class DebugKt {
    public static /* synthetic */ void printDebug$default(Grammar grammar, int i, int i2, Object obj) throws NoWhenBranchMatchedException {
        if ((i2 & 1) != 0) {
            i = 0;
        }
    ...
    public static final void printDebug(Grammar grammar, int i) throws NoWhenBranchMatchedException {
        Intrinsics.checkNotNullParameter(grammar, "<this>");
        if (grammar instanceof StringGrammar) {
            printlnWithOffset(i, "STRING[" + Regex.INSTANCE.escape(((StringGrammar) grammar).getValue()) + ']');
            return;
        }
        ...
        if (grammar instanceof OrGrammar) {
            ...
            Iterator it2 = ((OrGrammar) grammar).getGrammars().iterator();
            while (it2.hasNext()) {
        ...
        if (grammar instanceof AtLeastOne) {
            ...
            printlnWithOffset(i, "ANY_OF[" + Regex.INSTANCE.escape(((AnyOfGrammar) grammar).getValue()) + ']');
        } else {
            if (!(grammar instanceof RangeGrammar)) {
                throw new NoWhenBranchMatchedException();
            }
            RangeGrammar rangeGrammar = (RangeGrammar) grammar;
            printlnWithOffset(i, "RANGE[" + rangeGrammar.getFrom() + '-' + rangeGrammar.getTo() + ']');
        }
    }
