...
public final class DelimitedKt {
    ...
    static final class AnonymousClass1 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return DelimitedKt.readUntilDelimiterSuspend(null, null, null, 0, (Continuation) this);
        }
    }
    ...
    public static final Object readUntilDelimiter(ByteReadChannel byteReadChannel, final ByteBuffer byteBuffer, final ByteBuffer byteBuffer2, Continuation<? super Integer> continuation) {
        ...
        byteReadChannel.lookAhead(new Function1<LookAheadSession, Unit>() { // from class: io.ktor.utils.io.DelimitedKt.readUntilDelimiter.2
            ...
            public final void invoke(LookAheadSession lookAheadSession) {
                ...
                do {
                    int iTryCopyUntilDelimiter = DelimitedKt.tryCopyUntilDelimiter(lookAheadSession, byteBuffer, byteBuffer2);
    ...
    public static final Object skipDelimiter(ByteReadChannel byteReadChannel, final ByteBuffer byteBuffer, Continuation<? super Unit> continuation) {
        ...
        byteReadChannel.lookAhead(new Function1<LookAheadSession, Unit>() { // from class: io.ktor.utils.io.DelimitedKt.skipDelimiter.2
            ...
            public final void invoke(LookAheadSession lookAheadSession) {
                Intrinsics.checkNotNullParameter(lookAheadSession, "$this$lookAhead");
                booleanRef.element = DelimitedKt.tryEnsureDelimiter(lookAheadSession, byteBuffer) == byteBuffer.remaining();
            }
        });
    ...
    static final class C01172 extends SuspendLambda implements Function2<LookAheadSuspendSession, Continuation<? super Unit>, Object> {
        final /* synthetic */ ByteBuffer $delimiter;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01172(ByteBuffer byteBuffer, Continuation<? super C01172> continuation) {
            super(2, continuation);
            this.$delimiter = byteBuffer;
        }

        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            Continuation<Unit> c01172 = new C01172(this.$delimiter, continuation);
            c01172.L$0 = obj;
            return c01172;
        }
        ...
        public final Object invokeSuspend(Object obj) throws IOException {
            ...
            if (DelimitedKt.tryEnsureDelimiter((LookAheadSession) lookAheadSuspendSession, this.$delimiter) != this.$delimiter.remaining()) {
    ...
    public static final Object skipDelimiterSuspend(ByteReadChannel byteReadChannel, ByteBuffer byteBuffer, Continuation<? super Unit> continuation) {
        Object objLookAheadSuspend = byteReadChannel.lookAheadSuspend(new C01172(byteBuffer, null), continuation);
        ...
        if (iIndexOfPartial != -1) {
            ...
            if (iRemaining == 0) {
                ...
                if (byteBufferRequest2 == null) {
                    Intrinsics.checkNotNullExpressionValue(byteBufferDuplicate, "remembered");
            ...
            iPutAtMost$default = UtilsKt.putAtMost$default(byteBuffer2, byteBufferRequest, 0, 2, (Object) null);
        }
        lookAheadSession.consumed(iPutAtMost$default);
