...
public final class ObjectPoolKt {
    ...
    static {
        ...
        int iOIntProperty2 = UtilsKt.getIOIntProperty("BufferPoolSize", RendererCapabilities.AUDIO_OFFLOAD_SPEED_CHANGE_SUPPORTED);
        BUFFER_POOL_SIZE = iOIntProperty2;
        final int iOIntProperty3 = UtilsKt.getIOIntProperty("BufferObjectPoolSize", RendererCapabilities.AUDIO_OFFLOAD_GAPLESS_SUPPORTED);
        ...
        BufferObjectPool = new DefaultPool<ReadWriteBufferState.Initial>(iOIntProperty3) { // from class: io.ktor.utils.io.internal.ObjectPoolKt$BufferObjectPool$1
            ...
            public ReadWriteBufferState.Initial m1331produceInstance() {
        ...
        BufferObjectNoPool = new NoPoolImpl<ReadWriteBufferState.Initial>() { // from class: io.ktor.utils.io.internal.ObjectPoolKt$BufferObjectNoPool$1
            ...
            public ReadWriteBufferState.Initial m1330borrow() {
                ...
                return new ReadWriteBufferState.Initial(byteBufferAllocateDirect, 0, 2, (DefaultConstructorMarker) null);
            }
        };
    }
