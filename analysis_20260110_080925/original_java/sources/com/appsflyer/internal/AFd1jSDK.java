...
public final class AFd1jSDK {
    ...
    public final AFd1aSDK<String> getMonetizationNetwork(AFd1cSDK aFd1cSDK) throws IOException {
        ...
        try {
            ...
            StringBuilder sb = new StringBuilder(new StringBuilder().append(aFd1cSDK.getRevenue).append(":").append(aFd1cSDK.getMonetizationNetwork).toString());
            byte[] revenue2 = aFd1cSDK.getRevenue();
            if (aFd1cSDK.getCurrencyIso4217Code() && revenue2 != null) {
                try {
                    sb.append("\n payload: ").append(aFd1cSDK.AFAdRevenueData() ? "<encrypted>" : new String(revenue2, Charset.defaultCharset()));
                } catch (Throwable th) {
                    th = th;
                    httpURLConnection = null;
                    try {
                        AFd1hSDK aFd1hSDK = new AFd1hSDK(System.currentTimeMillis() - jCurrentTimeMillis);
                        AFLogger.INSTANCE.e(AFg1cSDK.component2, new StringBuilder("[").append(aFd1cSDK.hashCode()).append("] ").append(new StringBuilder("error: ").append(th).append("\n took ").append(aFd1hSDK.getRevenue).append("ms").toString()).toString(), th, false, false, false);
            ...
            for (Map.Entry entry : aFd1cSDK.AFAdRevenueData.entrySet()) {
                sb.append("\n ").append((String) entry.getKey()).append(": ").append((String) entry.getValue());
            }
            AFLogger.INSTANCE.d(AFg1cSDK.component2, new StringBuilder("[").append(aFd1cSDK.hashCode()).append("] ").append((Object) sb).toString());
            ...
            try {
                ...
                try {
                    ...
                    httpURLConnection2.addRequestProperty("Content-Type", aFd1cSDK.AFAdRevenueData() ? "application/octet-stream" : HttpRequest.CONTENT_TYPE_JSON);
                    for (Map.Entry entry2 : aFd1cSDK.AFAdRevenueData.entrySet()) {
                        httpURLConnection2.setRequestProperty((String) entry2.getKey(), (String) entry2.getValue());
                    }
                    if (revenue != null) {
                        httpURLConnection2.setDoOutput(true);
                        httpURLConnection2.setRequestProperty(HttpRequest.HEADER_CONTENT_LENGTH, new StringBuilder().append(revenue.length).toString());
                        try {
                    ...
                    String mediationNetwork = aFd1cSDK.getMediationNetwork() ? getMediationNetwork(httpURLConnection2) : BuildConfig.FLAVOR;
                    AFd1hSDK aFd1hSDK2 = new AFd1hSDK(System.currentTimeMillis() - jCurrentTimeMillis);
                    AFLogger.INSTANCE.d(AFg1cSDK.component2, new StringBuilder("[").append(aFd1cSDK.hashCode()).append("] ").append(new StringBuilder("response code:").append(httpURLConnection2.getResponseCode()).append(" ").append(httpURLConnection2.getResponseMessage()).append("\n body:").append(mediationNetwork).append("\n took ").append(aFd1hSDK2.getRevenue).append("ms").toString()).toString());
                    ...
                    AFLogger.INSTANCE.e(AFg1cSDK.component2, new StringBuilder("[").append(aFd1cSDK.hashCode()).append("] ").append(new StringBuilder("error: ").append(th).append("\n took ").append(aFd1hSDK3.getRevenue).append("ms").toString()).toString(), th, false, false, false);
    ...
    */
    private static java.lang.String getMediationNetwork(java.net.HttpURLConnection r11) throws java.lang.Throwable {
        ...
        Lb:
            ...
            com.appsflyer.internal.AFg1cSDK r3 = com.appsflyer.internal.AFg1cSDK.component2     // Catch: java.lang.Throwable -> L8
