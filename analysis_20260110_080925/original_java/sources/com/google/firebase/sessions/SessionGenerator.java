...
public final class SessionGenerator {
    ...
    private final String generateSessionId() {
        String string = ((UUID) this.uuidGenerator.invoke()).toString();
        Intrinsics.checkNotNullExpressionValue(string, "uuidGenerator().toString()");
        String lowerCase = StringsKt.replace$default(string, "-", BuildConfig.FLAVOR, false, 4, (Object) null).toLowerCase(Locale.ROOT);
