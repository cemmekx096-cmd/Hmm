...
public final class Iterables {
    ...
    public static <T> Iterable<T> unmodifiableIterable(Iterable<? extends T> iterable) {
        ...
        return ((iterable instanceof UnmodifiableIterable) || (iterable instanceof ImmutableCollection)) ? iterable : (Iterable<T>) new UnmodifiableIterable(iterable);
    }
    ...
    public static <T> Iterable<T> mergeSorted(final Iterable<? extends Iterable<? extends T>> iterable, final Comparator<? super T> comparator) {
        ...
        return (Iterable<T>) new UnmodifiableIterable(new FluentIterable<T>() { // from class: com.google.common.collect.Iterables.9
            public Iterator<T> iterator() {
