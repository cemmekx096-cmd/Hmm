...
public abstract class CodedOutputStream extends ByteOutput {
        ...
        public final void writeUInt32NoTag(int value) throws IOException {
            while ((value & (-128)) != 0) {
                try {
                    ...
                    int i = this.position;
                    this.position = i + 1;
                    bArr[i] = (byte) ((value & 127) | RendererCapabilities.DECODER_SUPPORT_PRIMARY);
                    value >>>= 7;
                } catch (IndexOutOfBoundsException e) {
                    throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.position), Integer.valueOf(this.limit), 1), e);
                }
        ...
        public final void writeUInt64NoTag(long value) throws IOException {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS && spaceLeft() >= 10) {
                while ((value & (-128)) != 0) {
                    ...
                    int i = this.position;
                    this.position = i + 1;
                    UnsafeUtil.putByte(bArr, i, (byte) ((((int) value) & 127) | RendererCapabilities.DECODER_SUPPORT_PRIMARY));
                    value >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i2 = this.position;
            ...
            while ((value & (-128)) != 0) {
                try {
                    ...
                    this.position = i3 + 1;
                    bArr3[i3] = (byte) ((((int) value) & 127) | RendererCapabilities.DECODER_SUPPORT_PRIMARY);
                    value >>>= 7;
                } catch (IndexOutOfBoundsException e) {
                    throw new OutOfSpaceException(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.position), Integer.valueOf(this.limit), 1), e);
                }
    ...
    private static final class SafeDirectNioEncoder extends CodedOutputStream {
        ...
        public void writeUInt32NoTag(int value) throws IOException {
            while ((value & (-128)) != 0) {
                try {
                    this.buffer.put((byte) ((value & 127) | RendererCapabilities.DECODER_SUPPORT_PRIMARY));
                    value >>>= 7;
                } catch (BufferOverflowException e) {
                    throw new OutOfSpaceException(e);
                }
        ...
        public void writeUInt64NoTag(long value) throws IOException {
            while (((-128) & value) != 0) {
                try {
                    this.buffer.put((byte) ((((int) value) & 127) | RendererCapabilities.DECODER_SUPPORT_PRIMARY));
                    value >>>= 7;
                } catch (BufferOverflowException e) {
                    throw new OutOfSpaceException(e);
                }
        ...
        public void writeUInt32NoTag(int value) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while ((value & (-128)) != 0) {
                    long j = this.position;
                    this.position = j + 1;
                    UnsafeUtil.putByte(j, (byte) ((value & 127) | RendererCapabilities.DECODER_SUPPORT_PRIMARY));
                    value >>>= 7;
                }
            ...
            while (true) {
                ...
                if ((value & (-128)) == 0) {
                    ...
                    this.position = j3 + 1;
                    UnsafeUtil.putByte(j3, (byte) ((value & 127) | RendererCapabilities.DECODER_SUPPORT_PRIMARY));
                    value >>>= 7;
                }
            }
        }
        ...
        public void writeUInt64NoTag(long value) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while ((value & (-128)) != 0) {
                    long j = this.position;
                    this.position = j + 1;
                    UnsafeUtil.putByte(j, (byte) ((((int) value) & 127) | RendererCapabilities.DECODER_SUPPORT_PRIMARY));
                    value >>>= 7;
                }
                long j2 = this.position;
                this.position = 1 + j2;
            ...
            while (true) {
                ...
                if ((value & (-128)) == 0) {
                    ...
                    this.position = j3 + 1;
                    UnsafeUtil.putByte(j3, (byte) ((((int) value) & 127) | RendererCapabilities.DECODER_SUPPORT_PRIMARY));
                    value >>>= 7;
                }
            }
        }
        ...
        final void bufferUInt32NoTag(int value) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while ((value & (-128)) != 0) {
                    ...
                    int i = this.position;
                    this.position = i + 1;
                    UnsafeUtil.putByte(bArr, i, (byte) ((value & 127) | RendererCapabilities.DECODER_SUPPORT_PRIMARY));
                    value >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i2 = this.position;
            ...
            while ((value & (-128)) != 0) {
                ...
                int i3 = this.position;
                this.position = i3 + 1;
                bArr3[i3] = (byte) ((value & 127) | RendererCapabilities.DECODER_SUPPORT_PRIMARY);
                this.totalBytesWritten++;
                value >>>= 7;
            }
            byte[] bArr4 = this.buffer;
    ...
    private static final class OutputStreamEncoder extends AbstractBufferedEncoder {
        ...
        @Override // com.google.protobuf.CodedOutputStream
        public void writeString(final int fieldNumber, final String value) throws IOException, Utf8.UnpairedSurrogateException {
            writeTag(fieldNumber, 2);
            writeStringNoTag(value);
        }
        ...
        /* JADX INFO: Thrown type has an unknown type hierarchy: com.google.protobuf.Utf8$UnpairedSurrogateException */
        @Override // com.google.protobuf.CodedOutputStream
        public void writeStringNoTag(String value) throws IOException, Utf8.UnpairedSurrogateException {
            int iEncodedLength;
            try {
                int length = value.length() * 3;
                int iComputeUInt32SizeNoTag = computeUInt32SizeNoTag(length);
