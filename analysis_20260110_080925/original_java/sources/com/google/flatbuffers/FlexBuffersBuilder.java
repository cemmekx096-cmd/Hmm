...
public class FlexBuffersBuilder {
    ...
    public int endVector(String str, int i, boolean z, boolean z2) throws FlexBuffers.FlexBufferException {
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: com.google.flatbuffers.FlexBuffers$FlexBufferException */
    private Value createVector(int i, int i2, int i3, boolean z, boolean z2, Value value) throws FlexBuffers.FlexBufferException {
        int i4;
        int typedVector;
        int i5 = i3;
        long j = i5;
    ...
    public int endMap(String str, int i) throws FlexBuffers.FlexBufferException {
        int iPutKey = putKey(str);
