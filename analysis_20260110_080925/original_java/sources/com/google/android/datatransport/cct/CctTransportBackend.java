...
final class CctTransportBackend implements TransportBackend {
        ...
        for (Map.Entry entry : map.entrySet()) {
            ...
            for (EventInternal eventInternal3 : (List) entry.getValue()) {
                ...
                if (encoding.equals(Encoding.of("proto"))) {
                    ...
                    builderProtoBuilder = LogEvent.jsonBuilder(new String(encodedPayload.getBytes(), Charset.forName(io.fabric.sdk.android.services.network.HttpRequest.CHARSET_UTF8)));
                } else {
    ...
    public HttpResponse doSend(HttpRequest httpRequest) throws IOException {
        ...
        httpURLConnection.setRequestProperty(io.fabric.sdk.android.services.network.HttpRequest.HEADER_USER_AGENT, String.format("datatransport/%s android/", "3.3.0"));
            ...
            try {
                ...
                try {
                    ...
                    if (responseCode == 302 || responseCode == 301 || responseCode == 307) {
                        return new HttpResponse(responseCode, new URL(httpURLConnection.getHeaderField(io.fabric.sdk.android.services.network.HttpRequest.HEADER_LOCATION)), 0L);
                    }
                    if (responseCode != 200) {
    ...
    public BackendResponse send(BackendRequest backendRequest) {
        ...
        try {
            HttpResponse httpResponse = (HttpResponse) Retries.retry(5, new HttpRequest(urlOrThrow, requestBody, aPIKey), new CctTransportBackend$.ExternalSyntheticLambda0(this), new CctTransportBackend$.ExternalSyntheticLambda1());
    ...
    static long getTzOffset() {
        ...
        return TimeZone.getDefault().getOffset(Calendar.getInstance().getTimeInMillis()) / VideoFeedsPlayer.INTERVAL_TIME_PLAY_TIME_CD_THREAD;
    }
