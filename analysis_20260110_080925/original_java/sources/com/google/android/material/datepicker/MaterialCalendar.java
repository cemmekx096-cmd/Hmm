...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    private void addActionsToMonthNavigation(View view, final MonthsPagerAdapter monthsPagerAdapter) {
        final MaterialButton materialButtonFindViewById = view.findViewById(R.id.month_navigation_fragment_toggle);
        materialButtonFindViewById.setTag(SELECTOR_TOGGLE_TAG);
        ViewCompat.setAccessibilityDelegate(materialButtonFindViewById, new AccessibilityDelegateCompat() { // from class: com.google.android.material.datepicker.MaterialCalendar.5
            @Override // androidx.core.view.AccessibilityDelegateCompat
        ...
        MaterialButton materialButtonFindViewById2 = view.findViewById(R.id.month_navigation_previous);
        materialButtonFindViewById2.setTag(NAVIGATION_PREV_TAG);
        MaterialButton materialButtonFindViewById3 = view.findViewById(R.id.month_navigation_next);
        materialButtonFindViewById3.setTag(NAVIGATION_NEXT_TAG);
        this.yearFrame = view.findViewById(R.id.mtrl_calendar_year_selector_frame);
        this.dayFrame = view.findViewById(R.id.mtrl_calendar_day_selector_frame);
        setSelector(CalendarSelector.DAY);
        materialButtonFindViewById.setText(this.current.getLongName(view.getContext()));
        this.recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() { // from class: com.google.android.material.datepicker.MaterialCalendar.6
            public void onScrolled(RecyclerView recyclerView, int i, int i2) {
                ...
                materialButtonFindViewById.setText(monthsPagerAdapter.getPageTitle(iFindLastVisibleItemPosition));
            }

            public void onScrollStateChanged(RecyclerView recyclerView, int i) {
                if (i == 0) {
                    CharSequence text = materialButtonFindViewById.getText();
                    if (Build.VERSION.SDK_INT >= 16) {
                        recyclerView.announceForAccessibility(text);
                    } else {
                        recyclerView.sendAccessibilityEvent(RendererCapabilities.AUDIO_OFFLOAD_SPEED_CHANGE_SUPPORTED);
                    }
                }
            }
        });
        materialButtonFindViewById.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.datepicker.MaterialCalendar.7
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                MaterialCalendar.this.toggleVisibleSelector();
            }
        });
        materialButtonFindViewById3.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.datepicker.MaterialCalendar.8
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
        ...
        materialButtonFindViewById2.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.datepicker.MaterialCalendar.9
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
