...
class zzamh<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    private final int zza(K k) {
        int i = this.zzb - 1;
        if (i >= 0) {
            int iCompareTo = k.compareTo((Comparable) ((zzaml) this.zza[i]).getKey());
            if (iCompareTo > 0) {
                return -(i + 2);
            }
            if (iCompareTo == 0) {
        ...
        while (i2 <= i) {
            int i3 = (i2 + i) / 2;
            int iCompareTo2 = k.compareTo((Comparable) ((zzaml) this.zza[i3]).getKey());
            if (iCompareTo2 < 0) {
                i = i3 - 1;
            } else {
                if (iCompareTo2 <= 0) {
    ...
    public V get(Object obj) {
        ...
        int iZza = zza((zzamh<K, V>) comparable);
        if (iZza >= 0) {
