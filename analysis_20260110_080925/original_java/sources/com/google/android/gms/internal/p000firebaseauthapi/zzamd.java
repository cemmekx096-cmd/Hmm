...
interface zzamd {
    ...
    <T> void zza(T t, zzamc<T> zzamcVar, zzajv zzajvVar) throws IOException;

    void zza(List<Boolean> list) throws IOException;

    @Deprecated
    <T> void zza(List<T> list, zzamc<T> zzamcVar, zzajv zzajvVar) throws IOException;

    <K, V> void zza(Map<K, V> map, zzale<K, V> zzaleVar, zzajv zzajvVar) throws IOException;

    float zzb() throws IOException;

    <T> void zzb(T t, zzamc<T> zzamcVar, zzajv zzajvVar) throws IOException;

    void zzb(List<zzaiw> list) throws IOException;

    <T> void zzb(List<T> list, zzamc<T> zzamcVar, zzajv zzajvVar) throws IOException;
