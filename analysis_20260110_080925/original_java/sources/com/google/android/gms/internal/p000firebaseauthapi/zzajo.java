...
public abstract class zzajo extends zzaix {
    ...
    private static class zza extends zzajo {
        ...
        @Override // com.google.android.gms.internal.p000firebaseauthapi.zzajo
        ...
        @Override // com.google.android.gms.internal.p000firebaseauthapi.zzaix
        ...
        public final void zzb(String str) throws IOException {
            int i = this.zzd;
            try {
                int iZzh = zzh(str.length() * 3);
                int iZzh2 = zzh(str.length());
                if (iZzh2 == iZzh) {
                    int i2 = i + iZzh2;
                    this.zzd = i2;
                    int iZza = zzanb.zza(str, this.zzb, i2, zza());
                    this.zzd = i;
                    zzl((iZza - i) - iZzh2);
                    this.zzd = iZza;
                    return;
        ...
        public final void zzl(int i) throws IOException {
            ...
            while ((i & (-128)) != 0) {
                ...
                try {
                    this.zzb[i3] = (byte) (i | RendererCapabilities.DECODER_SUPPORT_PRIMARY);
                    i >>>= 7;
                    i3 = i2;
                } catch (IndexOutOfBoundsException e2) {
                    e = e2;
        ...
        public final void zzh(long j) throws IOException {
            ...
            if (zzajo.zzc && zza() >= 10) {
                while ((j & (-128)) != 0) {
                    zzana.zza(this.zzb, i3, (byte) (((int) j) | RendererCapabilities.DECODER_SUPPORT_PRIMARY));
                    j >>>= 7;
                    i3++;
                }
                i = i3 + 1;
                ...
                while ((j & (-128)) != 0) {
                    ...
                    try {
                        this.zzb[i3] = (byte) (((int) j) | RendererCapabilities.DECODER_SUPPORT_PRIMARY);
                        j >>>= 7;
                        i3 = i2;
                    } catch (IndexOutOfBoundsException e2) {
                        e = e2;
        ...
        final void zzn(int i) {
            if (zzajo.zzc) {
                ...
                while ((i & (-128)) != 0) {
                    ...
                    int i2 = this.zzd;
                    this.zzd = i2 + 1;
                    zzana.zza(bArr, i2, (byte) (i | RendererCapabilities.DECODER_SUPPORT_PRIMARY));
                    i >>>= 7;
                }
                byte[] bArr2 = this.zzb;
                int i3 = this.zzd;
            ...
            while ((i & (-128)) != 0) {
                ...
                int i4 = this.zzd;
                this.zzd = i4 + 1;
                bArr3[i4] = (byte) (i | RendererCapabilities.DECODER_SUPPORT_PRIMARY);
                this.zze++;
                i >>>= 7;
            }
            byte[] bArr4 = this.zzb;
        ...
        final void zzj(long j) {
            if (zzajo.zzc) {
                ...
                while ((j & (-128)) != 0) {
                    ...
                    int i = this.zzd;
                    this.zzd = i + 1;
                    zzana.zza(bArr, i, (byte) (((int) j) | RendererCapabilities.DECODER_SUPPORT_PRIMARY));
                    j >>>= 7;
                }
                byte[] bArr2 = this.zzb;
                int i2 = this.zzd;
            ...
            while ((j & (-128)) != 0) {
                ...
                int i3 = this.zzd;
                this.zzd = i3 + 1;
                bArr3[i3] = (byte) (((int) j) | RendererCapabilities.DECODER_SUPPORT_PRIMARY);
                this.zze++;
                j >>>= 7;
            }
            byte[] bArr4 = this.zzb;
    ...
    abstract void zzc(int i, zzaln zzalnVar, zzamc zzamcVar) throws IOException;
    ...
    private static final class zzc extends zzb {
        ...
        /* JADX INFO: Thrown type has an unknown type hierarchy: com.google.android.gms.internal.firebase-auth-api.zzane */
        @Override // com.google.android.gms.internal.p000firebaseauthapi.zzajo
        public final void zzb(String str) throws zzane, IOException {
            int iZza;
            try {
                ...
                try {
                    if (iZzh2 == iZzh) {
                        this.zzd = i2 + iZzh2;
                        int iZza3 = zzanb.zza(str, this.zzb, this.zzd, this.zzc - this.zzd);
                        this.zzd = i2;
                        iZza = (iZza3 - i2) - iZzh2;
                        zzn(iZza);
                        this.zzd = iZza3;
    ...
    @Deprecated
    static int zza(int i, zzaln zzalnVar, zzamc zzamcVar) {
    ...
    static int zzb(int i, zzaln zzalnVar, zzamc zzamcVar) {
