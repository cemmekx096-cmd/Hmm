...
public final class zzamy {
    ...
    public final int zza() {
        ...
        for (int i3 = 0; i3 < this.zzb; i3++) {
            ...
            int i6 = i4 & 7;
            if (i6 == 0) {
                iZze = zzajo.zze(i5, ((Long) this.zzd[i3]).longValue());
            } else if (i6 == 1) {
                iZze = zzajo.zza(i5, ((Long) this.zzd[i3]).longValue());
            } else if (i6 == 2) {
                iZze = zzajo.zza(i5, (zzaiw) this.zzd[i3]);
            } else if (i6 == 3) {
                iZze = (zzajo.zzg(i5) << 1) + ((zzamy) this.zzd[i3]).zza();
            } else {
                if (i6 != 5) {
                    throw new IllegalStateException(zzakm.zza());
                }
                iZze = zzajo.zzb(i5, ((Integer) this.zzd[i3]).intValue());
            }
            i2 += iZze;
        }
        this.zze = i2;
    ...
    public final int zzb() {
        ...
        for (int i2 = 0; i2 < this.zzb; i2++) {
            iZzb += zzajo.zzb(this.zzc[i2] >>> 3, (zzaiw) this.zzd[i2]);
        }
        this.zze = iZzb;
        return iZzb;
    }
    ...
    final void zza(zzanm zzanmVar) throws IOException {
        if (zzanmVar.zza() == 2) {
