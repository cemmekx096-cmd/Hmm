...
public final class Tx3gDecoder extends SimpleSubtitleDecoder {
    ...
    /* JADX INFO: Thrown type has an unknown type hierarchy: com.mbridge.msdk.playercommon.exoplayer2.text.SubtitleDecoderException */
    ...
    private static String readSubtitleText(ParsableByteArray parsableByteArray) throws SubtitleDecoderException {
        ...
        int unsignedShort = parsableByteArray.readUnsignedShort();
        return unsignedShort == 0 ? BuildConfig.FLAVOR : (parsableByteArray.bytesLeft() < 2 || !((cPeekChar = parsableByteArray.peekChar()) == 65279 || cPeekChar == 65534)) ? parsableByteArray.readString(unsignedShort, Charset.forName(HttpRequest.CHARSET_UTF8)) : parsableByteArray.readString(unsignedShort, Charset.forName("UTF-16"));
    }
    ...
    protected Subtitle decode(byte[] bArr, int i, boolean z) throws SubtitleDecoderException {
        ...
        attachFontFamily(spannableStringBuilder, this.defaultFontFamily, DEFAULT_FONT_FAMILY, 0, spannableStringBuilder.length(), SPAN_PRIORITY_LOW);
        ...
        return new Tx3gSubtitle(new Cue(spannableStringBuilder, (Layout.Alignment) null, fConstrainValue, 0, 0, Float.MIN_VALUE, ExoMediaDrm.KeyRequest.REQUEST_TYPE_UNKNOWN, Float.MIN_VALUE));
    }
}
