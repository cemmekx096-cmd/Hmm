...
public class WindVaneWebView extends BaseWebView {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        b bVar = ((BaseWebView) this).mWebViewClient;
    ...
    public void release() {
        ...
        try {
            ...
            if (t0.b(getContext()) == 0) {
                ...
                new Handler().postDelayed(new a(), r0 * VideoFeedsPlayer.INTERVAL_TIME_PLAY_TIME_CD_THREAD);
            }
        } catch (Throwable th) {
            th.printStackTrace();
        }
    ...
    protected void a() {
        ...
        k kVar = new k();
        ((BaseWebView) this).mWebViewClient = kVar;
        setWebViewClient(kVar);
        if (this.e == null) {
            h hVar = new h(((BaseWebView) this).a);
            this.e = hVar;
            setSignalCommunication(hVar);
        }
        this.f = new e(((BaseWebView) this).a, this);
    }
