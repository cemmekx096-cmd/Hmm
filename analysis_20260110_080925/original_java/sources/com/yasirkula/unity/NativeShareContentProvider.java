...
public class NativeShareContentProvider extends ContentProvider {
    ...
    private static PathStrategy parsePathStrategy(Context context, String str) throws XmlPullParserException, IOException {
        ...
        context.getPackageManager().resolveContentProvider(str, RendererCapabilities.DECODER_SUPPORT_PRIMARY).loadXmlMetaData(context.getPackageManager(), META_DATA_FILE_PROVIDER_PATHS);
