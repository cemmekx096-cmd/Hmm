...
public class JavaScriptSessionService {
    ...
    private void addWebViewListener() {
        ...
        webViewUtil.a(this.webView, JS_MESSAGE_LISTENER_JS_SESSION_SERVICE, new HashSet(Arrays.asList(Marker.ANY_MARKER)), new WebViewCompat.WebMessageListener() { // from class: com.iab.omid.library.bytedance2.adsession.JavaScriptSessionService.2
