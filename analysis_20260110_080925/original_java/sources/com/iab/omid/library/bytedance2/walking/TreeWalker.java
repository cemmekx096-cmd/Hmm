...
public class TreeWalker implements a.a {
    ...
    private boolean a(View view, JSONObject jSONObject) {
        a.C0032a c0032aC = this.f.c(view);
        if (c0032aC == null) {
            return false;
        }
        com.iab.omid.library.bytedance2.utils.c.a(jSONObject, c0032aC);
        return true;
    }
    ...
    private void e() {
        ...
        this.d.clear();
        this.c = false;
        Iterator it = com.iab.omid.library.bytedance2.internal.c.c().a().iterator();
        while (true) {
            if (!it.hasNext()) {
                break;
            } else if (((com.iab.omid.library.bytedance2.adsession.a) it.next()).e()) {
                this.c = true;
                break;
            }
        }
    ...
    void f() {
        ...
        if (this.f.c().size() > 0) {
            ...
            if (this.c) {
                Iterator it2 = com.iab.omid.library.bytedance2.internal.c.c().a().iterator();
                while (it2.hasNext()) {
                    ((com.iab.omid.library.bytedance2.adsession.a) it2.next()).a(this.d);
                }
            }
        } else {
            this.g.b();
