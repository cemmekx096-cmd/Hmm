...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object m1342receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.receiveCatching-JP2dKIU(continuation);
    ...
    public Object m1343tryReceivePtdJZtk() {
        return this._channel.tryReceive-PtdJZtk();
    }

    /* renamed from: trySend-JP2dKIU, reason: not valid java name */
    public Object m1344trySendJP2dKIU(E element) {
    ...
    public final void cancel(CancellationException cause) {
        ...
        if (cause == null) {
            ...
            cause = (CancellationException) new JobCancellationException(JobSupport.access$cancellationExceptionMessage(job), (Throwable) null, job);
        }
        cancelInternal(cause);
    }

    public void cancelInternal(Throwable cause) {
        CancellationException cancellationException$default = JobSupport.toCancellationException$default((JobSupport) this, cause, (String) null, 1, (Object) null);
