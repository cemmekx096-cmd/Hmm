...
class CollectionsKt__MutableCollectionsJVMKt extends CollectionsKt__IteratorsKt {
    ...
    private static final <T> void sort(List<T> list, Comparator<? super T> comparator) throws NotImplementedError {
    ...
    private static final <T> void sort(List<T> list, Function2<? super T, ? super T, Integer> function2) throws NotImplementedError {
        Intrinsics.checkNotNullParameter(list, "<this>");
