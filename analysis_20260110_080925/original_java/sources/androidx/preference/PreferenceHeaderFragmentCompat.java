...
public abstract class PreferenceHeaderFragmentCompat extends Fragment implements PreferenceFragmentCompat.OnPreferenceStartFragmentCallback {
    ...
    public boolean onPreferenceStartFragment(PreferenceFragmentCompat caller, Preference pref) {
        ...
        fragmentTransactionBeginTransaction.addToBackStack((String) null);
        fragmentTransactionBeginTransaction.commit();
        return true;
    }

    /* compiled from: PreferenceHeaderFragmentCompat.kt */
    @Metadata(d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0007\n\u0000\b\u0002\u0018\u00002\u00020\u00012\u00020\u0002B\r\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0002\u0010\u0005J\b\u0010\u0006\u001a\u00020\u0007H\u0016J\u0010\u0010\b\u001a\u00020\u00072\u0006\u0010\t\u001a\u00020\nH\u0016J\u0010\u0010\u000b\u001a\u00020\u00072\u0006\u0010\t\u001a\u00020\nH\u0016J\u0018\u0010\f\u001a\u00020\u00072\u0006\u0010\t\u001a\u00020\n2\u0006\u0010\r\u001a\u00020\u000eH\u0016R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u000f"}, d2 = {"Landroidx/preference/PreferenceHeaderFragmentCompat$InnerOnBackPressedCallback;", "Landroidx/activity/OnBackPressedCallback;", "Landroidx/slidingpanelayout/widget/SlidingPaneLayout$PanelSlideListener;", "caller", "Landroidx/preference/PreferenceHeaderFragmentCompat;", "(Landroidx/preference/PreferenceHeaderFragmentCompat;)V", "handleOnBackPressed", BuildConfig.FLAVOR, "onPanelClosed", "panel", "Landroid/view/View;", "onPanelOpened", "onPanelSlide", "slideOffset", BuildConfig.FLAVOR, "preference_release"}, k = 1, mv = {1, 6, 0}, xi = 48)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View viewBuildContentView = buildContentView(inflater);
        if (getChildFragmentManager().findFragmentById(R.id.preferences_header) == null) {
            Fragment fragmentOnCreatePreferenceHeader = onCreatePreferenceHeader();
            FragmentManager childFragmentManager = getChildFragmentManager();
            Intrinsics.checkNotNullExpressionValue(childFragmentManager, "childFragmentManager");
            FragmentTransaction fragmentTransactionBeginTransaction = childFragmentManager.beginTransaction();
            Intrinsics.checkNotNullExpressionValue(fragmentTransactionBeginTransaction, "beginTransaction()");
            fragmentTransactionBeginTransaction.setReorderingAllowed(true);
            fragmentTransactionBeginTransaction.add(R.id.preferences_header, fragmentOnCreatePreferenceHeader);
            fragmentTransactionBeginTransaction.commit();
        }
        viewBuildContentView.setLockMode(3);
        return viewBuildContentView;
    }
    ...
    private final SlidingPaneLayout buildContentView(LayoutInflater inflater) {
        ...
        ViewGroup.LayoutParams layoutParams = new SlidingPaneLayout.LayoutParams(getResources().getDimensionPixelSize(R.dimen.preferences_header_width), -1);
        ((SlidingPaneLayout.LayoutParams) layoutParams).weight = getResources().getInteger(R.integer.preferences_header_pane_weight);
        slidingPaneLayout.addView(fragmentContainerView, layoutParams);
        FragmentContainerView fragmentContainerView2 = new FragmentContainerView(inflater.getContext());
        fragmentContainerView2.setId(R.id.preferences_detail);
        ViewGroup.LayoutParams layoutParams2 = new SlidingPaneLayout.LayoutParams(getResources().getDimensionPixelSize(R.dimen.preferences_detail_width), -1);
        ((SlidingPaneLayout.LayoutParams) layoutParams2).weight = getResources().getInteger(R.integer.preferences_detail_pane_weight);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        OnBackPressedDispatcherOwner onBackPressedDispatcherOwnerRequireContext = requireContext();
        OnBackPressedDispatcherOwner onBackPressedDispatcherOwner = onBackPressedDispatcherOwnerRequireContext instanceof OnBackPressedDispatcherOwner ? onBackPressedDispatcherOwnerRequireContext : null;
    ...
    public static final void m52onViewCreated$lambda10(PreferenceHeaderFragmentCompat preferenceHeaderFragmentCompat) {
    ...
    public Fragment onCreateInitialDetailFragment() {
        PreferenceFragmentCompat preferenceFragmentCompatFindFragmentById = getChildFragmentManager().findFragmentById(R.id.preferences_header);
        if (preferenceFragmentCompatFindFragmentById == null) {
            throw new NullPointerException("null cannot be cast to non-null type androidx.preference.PreferenceFragmentCompat");
        }
        PreferenceFragmentCompat preferenceFragmentCompat = preferenceFragmentCompatFindFragmentById;
