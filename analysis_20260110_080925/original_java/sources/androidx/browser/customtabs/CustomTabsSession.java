...
import androidx.browser.customtabs.CustomTabsSession$1$;
...
public final class CustomTabsSession {
    ...
    private IEngagementSignalsCallback.Stub createEngagementSignalsCallbackWrapper(final EngagementSignalsCallback engagementSignalsCallback) {
        return new IEngagementSignalsCallback.Stub() { // from class: androidx.browser.customtabs.CustomTabsSession.1
