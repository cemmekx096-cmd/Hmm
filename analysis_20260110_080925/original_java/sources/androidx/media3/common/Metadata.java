...
public final class Metadata implements Parcelable {
    ...
    public String toString() {
        return "entries=" + Arrays.toString(this.entries) + (this.presentationTimeUs == -9223372036854775807L ? com.crashlytics.android.BuildConfig.FLAVOR : ", presentationTimeUs=" + this.presentationTimeUs);
    }
