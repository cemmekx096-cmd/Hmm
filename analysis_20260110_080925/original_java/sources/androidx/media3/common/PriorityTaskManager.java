...
public final class PriorityTaskManager {
    ...
    private int highestPriority = ExoMediaDrm.KeyRequest.REQUEST_TYPE_UNKNOWN;
    ...
    public void remove(int i) {
        synchronized (this.lock) {
            ...
            this.highestPriority = this.queue.isEmpty() ? ExoMediaDrm.KeyRequest.REQUEST_TYPE_UNKNOWN : ((Integer) Util.castNonNull(this.queue.peek())).intValue();
            this.lock.notifyAll();
        }
    }
}
