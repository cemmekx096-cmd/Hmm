...
public final class H265Reader implements ElementaryStreamReader {
    ...
    private final NalUnitTargetBuffer vps = new NalUnitTargetBuffer(32, RendererCapabilities.DECODER_SUPPORT_PRIMARY);
    private final NalUnitTargetBuffer sps = new NalUnitTargetBuffer(33, RendererCapabilities.DECODER_SUPPORT_PRIMARY);
    private final NalUnitTargetBuffer pps = new NalUnitTargetBuffer(34, RendererCapabilities.DECODER_SUPPORT_PRIMARY);
    private final NalUnitTargetBuffer prefixSei = new NalUnitTargetBuffer(39, RendererCapabilities.DECODER_SUPPORT_PRIMARY);
    private final NalUnitTargetBuffer suffixSei = new NalUnitTargetBuffer(40, RendererCapabilities.DECODER_SUPPORT_PRIMARY);
