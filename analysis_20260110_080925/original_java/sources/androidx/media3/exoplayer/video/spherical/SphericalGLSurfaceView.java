...
public final class SphericalGLSurfaceView extends GLSurfaceView {
    ...
    public SphericalGLSurfaceView(Context context, AttributeSet attributeSet) {
        ...
        OrientationListener.Listener touchTracker = new TouchTracker(context, renderer, PX_PER_DEGREES);
        this.touchTracker = touchTracker;
        this.orientationListener = new OrientationListener(((WindowManager) Assertions.checkNotNull((WindowManager) context.getSystemService("window"))).getDefaultDisplay(), new OrientationListener.Listener[]{touchTracker, renderer});
    ...
    private void updateOrientationListenerRegistration() {
        ...
        if (z) {
            this.sensorManager.registerListener((SensorEventListener) this.orientationListener, sensor, 0);
        } else {
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture) {
        this.mainHandler.post(new SphericalGLSurfaceView$.ExternalSyntheticLambda0(this, surfaceTexture));
    }
    ...
    /* synthetic */ void m47x24c550f4(SurfaceTexture surfaceTexture) {
    ...
    final class Renderer implements GLSurfaceView.Renderer, TouchTracker.Listener, OrientationListener.Listener {
        ...
        public void onSurfaceChanged(GL10 gl10, int i, int i2) {
            ...
            float f = i / i2;
            Matrix.perspectiveM(this.projectionMatrix, 0, calculateFieldOfViewInYDirection(f), f, SphericalGLSurfaceView.Z_NEAR, SphericalGLSurfaceView.Z_FAR);
        }
