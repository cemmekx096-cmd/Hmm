...
import androidx.media3.exoplayer.offline.DownloadService$DownloadManagerHelper$;
import androidx.media3.exoplayer.offline.DownloadService$ForegroundNotificationUpdater$;
...
public abstract class DownloadService extends Service {
    ...
    public static Intent buildAddDownloadIntent(Context context, Class<? extends DownloadService> cls, DownloadRequest downloadRequest, int i, boolean z) {
        return getIntent(context, cls, ACTION_ADD_DOWNLOAD, z).putExtra(KEY_DOWNLOAD_REQUEST, (Parcelable) downloadRequest).putExtra(KEY_STOP_REASON, i);
    }
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        switch (action) {
            ...
            case "androidx.media3.exoplayer.downloadService.action.ADD_DOWNLOAD":
                DownloadRequest parcelableExtra = ((Intent) Assertions.checkNotNull(intent)).getParcelableExtra(KEY_DOWNLOAD_REQUEST);
                if (parcelableExtra == null) {
                    Log.e(TAG, "Ignored ADD_DOWNLOAD: Missing download_request extra");
                    break;
                } else {
                    downloadManager.addDownload(parcelableExtra, intent.getIntExtra(KEY_STOP_REASON, 0));
                    break;
                }
    ...
    private static final class DownloadManagerHelper implements DownloadManager.Listener {
        ...
        public void attachService(DownloadService downloadService) {
            ...
            if (this.downloadManager.isInitialized()) {
                Util.createHandlerForCurrentOrMainLooper().postAtFrontOfQueue(new DownloadService$DownloadManagerHelper$.ExternalSyntheticLambda0(this, downloadService));
            }
        }
        ...
        /* synthetic */ void m35xee6ee963(DownloadService downloadService) {
