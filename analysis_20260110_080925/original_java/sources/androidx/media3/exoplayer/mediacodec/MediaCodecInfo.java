...
public final class MediaCodecInfo {
    ...
    public DecoderReuseEvaluation canReuseCodec(Format format, Format format2) {
        ...
        if (this.isVideo) {
            if (format.rotationDegrees != format2.rotationDegrees) {
                i |= RendererCapabilities.AUDIO_OFFLOAD_GAPLESS_SUPPORTED;
            }
            if (!this.adaptive && (format.width != format2.width || format.height != format2.height)) {
                i |= RendererCapabilities.AUDIO_OFFLOAD_SUPPORTED;
            }
            if (!Util.areEqual(format.colorInfo, format2.colorInfo)) {
                i |= RendererCapabilities.AUDIO_OFFLOAD_SPEED_CHANGE_SUPPORTED;
            }
    ...
    private static MediaCodecInfo.CodecProfileLevel[] estimateLegacyVp9ProfileLevels(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        ...
        int i = iIntValue >= 180000000 ? RendererCapabilities.AUDIO_OFFLOAD_GAPLESS_SUPPORTED : iIntValue >= 120000000 ? RendererCapabilities.AUDIO_OFFLOAD_SUPPORTED : iIntValue >= 60000000 ? 256 : iIntValue >= 30000000 ? RendererCapabilities.DECODER_SUPPORT_PRIMARY : iIntValue >= 18000000 ? 64 : iIntValue >= 12000000 ? 32 : iIntValue >= 7200000 ? 16 : iIntValue >= 3600000 ? 8 : iIntValue >= 1800000 ? 4 : iIntValue >= 800000 ? 2 : 1;
    ...
    private static final class Api29 {
        ...
        public static int areResolutionAndFrameRateCovered(MediaCodecInfo.VideoCapabilities videoCapabilities, String str, int i, int i2, double d) {
            ...
            if (iEvaluatePerformancePointCoverage == 1 && str.equals(MimeTypes.VIDEO_H264) && evaluatePerformancePointCoverage(supportedPerformancePoints, new MediaCodecInfo.VideoCapabilities.PerformancePoint(1280, 720, 60)) != 2) {
                return 0;
            }
