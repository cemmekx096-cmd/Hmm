...
import androidx.credentials.provider.PendingIntentHandler$Companion$;
...
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\b\u0007\u0018\u0000 \u00032\u00020\u0001:\u0001\u0003B\u0005¢\u0006\u0002\u0010\u0002¨\u0006\u0004"}, d2 = {"Landroidx/credentials/provider/PendingIntentHandler;", BuildConfig.FLAVOR, "()V", "Companion", "credentials_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
...
public final class PendingIntentHandler {
    ...
    public static final class Companion {
        ...
        public final ProviderCreateCredentialRequest retrieveProviderCreateCredentialRequest(Intent intent) throws FrameworkClassParsingException {
            ...
            androidx.credentials.CreateCredentialRequest createCredentialRequestCreateFrom = companion.createFrom(type, data, data2, false, providerCreateCredentialRequest.getCallingAppInfo().getOrigin());
            ...
            return new ProviderCreateCredentialRequest(createCredentialRequestCreateFrom, new CallingAppInfo(packageName, signingInfo, providerCreateCredentialRequest.getCallingAppInfo().getOrigin()));
        }
        ...
        public final ProviderGetCredentialRequest retrieveProviderGetCredentialRequest(Intent intent) {
            ...
            Object objCollect = getCredentialRequest.getCredentialOptions().stream().map(new PendingIntentHandler$Companion$.ExternalSyntheticLambda0(new Function1<CredentialOption, androidx.credentials.CredentialOption>() { // from class: androidx.credentials.provider.PendingIntentHandler$Companion$retrieveProviderGetCredentialRequest$1
