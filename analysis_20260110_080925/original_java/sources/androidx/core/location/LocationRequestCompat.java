...
public final class LocationRequestCompat {
    ...
    public static final class Builder {
        ...
        public LocationRequestCompat build() {
            Preconditions.checkState((this.mIntervalMillis == Long.MAX_VALUE && this.mMinUpdateIntervalMillis == LocationRequestCompat.IMPLICIT_MIN_UPDATE_INTERVAL) ? false : true, "passive location requests must have an explicit minimum update interval");
            long j = this.mIntervalMillis;
