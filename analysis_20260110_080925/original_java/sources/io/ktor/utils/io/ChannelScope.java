...
final class ChannelScope implements ReaderScope, WriterScope, CoroutineScope {
    ...
    /* renamed from: getChannel, reason: from getter and merged with bridge method [inline-methods] and merged with bridge method [inline-methods] */
    public ByteChannel m1328getChannel() {
        return this.channel;
    }
}
