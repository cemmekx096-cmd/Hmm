...
@Metadata(d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u0012\n\u0002\b\u0002\n\u0002\u0010\u0015\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0007\b\u0000\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0010\u001a\u00020\fH\u0016J\u0018\u0010\u0011\u001a\u00020\u00122\u0006\u0010\u0013\u001a\u00020\f2\u0006\u0010\u0014\u001a\u00020\u0004H\u0002J\b\u0010\u0015\u001a\u00020\u0012H\u0002J \u0010\u0016\u001a\u00020\u00122\u0006\u0010\u0013\u001a\u00020\f2\u0006\u0010\u0017\u001a\u00020\u00042\u0006\u0010\u0018\u001a\u00020\u0004H\u0016R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0004X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0004X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\nX\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u000b\u001a\u00020\fX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\r\u001a\u00020\u0004X\u0082\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u000e\u001a\u00020\u000fX\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0019"}, d2 = {"Lio/ktor/util/Sha1;", "Lio/ktor/util/HashFunction;", "()V", "h0", BuildConfig.FLAVOR, "h1", "h2", "h3", "h4", "messageLength", BuildConfig.FLAVOR, "unprocessed", BuildConfig.FLAVOR, "unprocessedLimit", "words", BuildConfig.FLAVOR, "digest", "processChunk", BuildConfig.FLAVOR, "input", "pos", "reset", "update", "offset", "length", "ktor-utils"}, k = 1, mv = {1, 8, 0}, xi = 48)
...
public final class Sha1 implements HashFunction {
    ...
    private final void processChunk(byte[] input, int pos) {
        ...
        while (true) {
            ...
            int i6 = i5 + 1;
            int i7 = i6 + 1;
            iArr[i4] = ((input[pos] & 255) << 24) | ((input[i5] & 255) << 16) | ((input[i6] & 255) << 8) | (input[i7] & 255);
            i4++;
            pos = i7 + 1;
        }
        for (i = 16; i < 80; i++) {
        ...
        while (i3 < 80) {
            if (i3 < 20) {
                ...
                iLeftRotate = ((HashFunctionKt.leftRotate(i8, 5) + (((i9 & iLeftRotate2) | (i9 & i10)) | (iLeftRotate2 & i10))) + i11) - 1894007588;
                i2 = iArr[i3];
            } else {
                iLeftRotate = ((HashFunctionKt.leftRotate(i8, 5) + ((i9 ^ iLeftRotate2) ^ i10)) + i11) - 899497514;
                i2 = iArr[i3];
            }
            int i12 = iLeftRotate + i2;
            i3++;
            i11 = i10;
            i10 = iLeftRotate2;
