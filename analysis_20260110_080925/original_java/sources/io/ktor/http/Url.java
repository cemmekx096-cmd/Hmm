    ...
    public Url(URLProtocol uRLProtocol, String str, int i, List<String> list, Parameters parameters, String str2, String str3, String str4, boolean z, String str5) {
        ...
        this.encodedPath = LazyKt.lazy(new Function0<String>() { // from class: io.ktor.http.Url$encodedPath$2
            ...
            public final String invoke() {
                ...
                if (this.this$0.getPathSegments().isEmpty() || (iIndexOf$default = StringsKt.indexOf$default(this.this$0.urlString, '/', this.this$0.getProtocol().getName().length() + 3, false, 4, (Object) null)) == -1) {
                    return BuildConfig.FLAVOR;
                }
                int iIndexOfAny$default = StringsKt.indexOfAny$default(this.this$0.urlString, new char[]{'?', '#'}, iIndexOf$default, false, 4, (Object) null);
        ...
        this.encodedQuery = LazyKt.lazy(new Function0<String>() { // from class: io.ktor.http.Url$encodedQuery$2
            ...
            public final String invoke() {
                int iIndexOf$default = StringsKt.indexOf$default(this.this$0.urlString, '?', 0, false, 6, (Object) null) + 1;
                if (iIndexOf$default == 0) {
                    return BuildConfig.FLAVOR;
                }
                int iIndexOf$default2 = StringsKt.indexOf$default(this.this$0.urlString, '#', iIndexOf$default, false, 4, (Object) null);
        ...
        this.encodedPathAndQuery = LazyKt.lazy(new Function0<String>() { // from class: io.ktor.http.Url$encodedPathAndQuery$2
            ...
            public final String invoke() {
                int iIndexOf$default = StringsKt.indexOf$default(this.this$0.urlString, '/', this.this$0.getProtocol().getName().length() + 3, false, 4, (Object) null);
        ...
        this.encodedUser = LazyKt.lazy(new Function0<String>() { // from class: io.ktor.http.Url$encodedUser$2
            ...
            public final String invoke() {
                ...
                String strSubstring = this.this$0.urlString.substring(length, StringsKt.indexOfAny$default(this.this$0.urlString, new char[]{':', '@'}, length, false, 4, (Object) null));
        ...
        this.encodedPassword = LazyKt.lazy(new Function0<String>() { // from class: io.ktor.http.Url$encodedPassword$2
            ...
            public final String invoke() {
                ...
                String strSubstring = this.this$0.urlString.substring(StringsKt.indexOf$default(this.this$0.urlString, ':', this.this$0.getProtocol().getName().length() + 3, false, 4, (Object) null) + 1, StringsKt.indexOf$default(this.this$0.urlString, '@', 0, false, 6, (Object) null));
                Intrinsics.checkNotNullExpressionValue(strSubstring, "this as java.lang.String…ing(startIndex, endIndex)");
                return strSubstring;
            }
        });
