...
public abstract class EventsHandler<T> implements EventsStorageListener {
    ...
    public void recordEventSync(final T t) throws ExecutionException, InterruptedException {
    ...
    protected void executeSync(Runnable runnable) throws ExecutionException, InterruptedException {
        try {
